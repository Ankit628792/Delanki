        ...
        <>
            <section className='flex flex-col justify-between min-h-screen w-full '>
                ...
                <div className='policy max-w-4xl rounded-lg p-5 md:p-10 xl:px-20 my-10 !m-5 lg:!mx-auto border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 filter backdrop-blur-lg'>
                    ...
                    <li>These terms and conditions outline the rules and regulations for the use of Nian Devs's Website, located at <a href='https://nian-devs.vercel.app' target="_blank" rel="noreferrer">Nian Devs</a>.</li>

                    <li>By accessing this website we assume you accept these terms and conditions. Do not continue to use Nian Devs if you do not agree to take all of the terms and conditions stated on this page.</li>
                    ...
                    <li>We employ the use of cookies. By accessing Nian Devs, you agreed to use cookies in agreement with the Nian Devs's Privacy Policy. </li>
                    ...
                    <li>Unless otherwise stated, Nian Devs and/or its licensors own the intellectual property rights for all material on Nian Devs. All intellectual property rights are reserved. You may access this from Nian Devs for your own personal use subjected to restrictions set in these terms and conditions.</li>

                    <li>You must not:</li>
                    <ul>
                        <li>Republish material from Nian Devs</li>
                        <li>Sell, rent or sub-license material from Nian Devs</li>
                        <li>Reproduce, duplicate or copy material from Nian Devs</li>
                        <li>Redistribute content from Nian Devs</li>
                    </ul>

                    <li>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Nian Devs does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Nian Devs,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Nian Devs shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>

                    <li>Nian Devs reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</li>
                    ...
                    <li>You hereby grant Nian Devs a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
                    ...
                    <li>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Nian Devs. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</li>
                    ...
                    <li>No use of Nian Devs's logo or other artwork will be allowed for linking absent a trademark license agreement.</li>
