    ...
    return (
        <footer className=''>
            ...
            <div className='flex flex-col items-center gap-4 py-20 bg-red'>
                <h1 className='text-4xl lg:text-5xl font-semibold text-white tracking-wide'>Ready to start the project?</h1>
                <div className='flex flex-col sm:flex-row sm:items-center gap-8 pt-10 pb-6'>
                    <div className='flex items-center gap-2 bg-white py-3 px-4 rounded-lg'>
                        ...
                        <div>
                            <a className='text-lg cursor-pointer text-gray-800 hover:text-blue-500 font-medium' href='https://www.linkedin.com/in/ankit628792/'>Ankit Kumar</a>
                    ...
                    <div className='flex items-center gap-2 bg-white py-3 px-4 rounded-lg'>
                        ...
                        <div>
                            <a className='text-lg cursor-pointer text-gray-800 hover:text-blue-500 font-medium' href='https://www.linkedin.com/in/nitesh-kumar-4a223716b/'>Nitesh Kumar</a>
            ...
            <div className='px-5 py-10 bg-gray-800 text-white'>
                ...
                <div className='flex flex-col sm:flex-row items-start justify-between w-full gap-y-6 max-w-6xl mx-auto py-4'>
