...
const products = [
  {
    id: 1,
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 rounded-full mx-auto lg:mx-0 bg-blue-300 text-blue-600 p-2 mb-2 shadow-lg shadow-blue-200">
  ...
  {
    id: 2,
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 rounded-full mx-auto lg:mx-0 bg-teal-300 text-teal-600 p-2 mb-2 shadow-lg shadow-teal-200">
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
    </svg>,
  ...
  {
    id: 3,
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 rounded-full mx-auto lg:mx-0 bg-rose-300 text-rose-600 p-2 mb-2 shadow-lg shadow-rose-200">
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
    </svg>,
...
function Products() {
  return (
    <section className='min-h-screen w-full p-5 lg:p-10'>
      ...
      <h1 className='font-bold text-center text-gray-800 text-4xl lg:text-5xl 2xl:text-6xl 2xl:max-w-xl tracking-wider max-w-lg mx-auto'>Our Best <span className='font-montez text-red'>Services</span> for your <span className='font-montez text-red'>Business</span></h1>

      {products.map(product => <div key={product.id} className='sm:min-h-screen grid place-items-center'>
        <div className={`flex flex-col gap-10 xl:gap-16 ${product.id % 2 == 0 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center justify-center w-full mx-auto my-10 p-5 py-10 sm:px-10 xl:px-16 rounded-2xl shadow-2xl ${product.background} min-h-[80vh]`}>
          <div className='flex-grow'>
            {/* Mobile Icon  */}
            {product.icon}

            <h1 className='font-medium text-gray-800 text-3xl lg:text-4xl 2xl:text-5xl 2xl:max-w-xl my-3 text-center lg:text-left lg:max-w-md'>{product.title}</h1>
          ...
          <div className='max-w-lg md:max-w-xl 2xl:max-w-2xl rounded-2xl overflow-hidden'>
