...
function Landing() {
    return (
        <header className='min-h-screen w-full p-5 lg:p-10'>
            <h1 className='font-bold text-center text-gray-800 dark:text-gray-50 text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl 2xl:max-w-2xl tracking-wider max-w-lg lg:max-w-xl mx-auto'>Build your <span className='font-montez text-red'>Product</span> with Nian Devs</h1>
